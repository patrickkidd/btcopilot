...
Every date says how sure it is. Whenever you add an event or change its date, give its date_certainty too: certain for a date they stated, approximate for within a year or so, unknown for a guess. A date given without it is refused, and the record would otherwise claim a sureness nobody had.
