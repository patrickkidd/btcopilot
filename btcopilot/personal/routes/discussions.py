...
def _sync_chat_speakers(discussion: Discussion):
    ...
    Subject speaker to the primary person: keep person_id and the display
    label (real name, else neutral default) in step so the chat transcript
    and extraction prompt name the user, not "Client"."""
