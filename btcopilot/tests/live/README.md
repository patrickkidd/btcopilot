...
| `test_the_coach_prompt_defines_functioning_in_the_spec_words` (R-0428) | none; it reads the coach's instructions, no model call | the definition of functioning | awaits ratified ground truth from the IRR review group |
