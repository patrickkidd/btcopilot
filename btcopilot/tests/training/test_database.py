...
def test_PDEvent_as_dict(relationship):
    assert Event(
        ...
        symptom=Symptom(shift=VariableShift.Down),
        functioning=Functioning(shift=VariableShift.Same),
        confidence=0.7,
    ).model_dump() == {
        "id": -2,
        "description": "Brother-in-law stopped talking during spring break due to stress.",
        "dateTime": "2025-03-01",
        "people": [-1],
        "symptom": {"shift": VariableShift.Down, "rationale": None},
        "anxiety": {"shift": VariableShift.Up, "rationale": None},
        "relationship": relationship.model_dump(),
        "functioning": {"shift": VariableShift.Same, "rationale": None},
        "confidence": 0.7,
    }
