...
**Source**: Exhaustive literature review in `doc/sarf-definitions/`
**Purpose**: Reference material for understanding SARF constructs. NOT for direct inclusion in extraction prompts.
