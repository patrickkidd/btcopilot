...
| 112 | 2026-09-15 | roles | Anyone could flag a ratified guideline and anyone could move a cut through the agenda; only an admin may, and the account button was missing its icon | IN PROGRESS | R-0346 was being built when the session stopped; nothing has landed on the branch, and one edit to the account button's mark is uncommitted in the worktree |
